...
function Film_Flip(props) {
    ...
    return (
        <div className="flip-card mt-5 mx-1">
            <div className="flip-card-inner">
                ...
                >
                    ...
                    <div className="w-full h-full"
                        style={{
                            position: 'absolute', backgroundColor: 'rgba(0,0,0,.5)',
            ...
            <div onClick={() => {
                ...
                className="bg-orange-300 text-center cursor-pointer py-2 w-full my-2 text-success-50 font-bold"
            >
                ĐẶT VÉ
            </div>
        </div>
