    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-6">
                    ...
                    <div className="divide-y divide-gray-700">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            {mangDanhMuc.map((danhMuc, index) => {
                                ...
                                const classNameActive = ['flex', 'items-center', 'p-2', 'space-x-3', 'rounded-md', maDanhMuc === danhMuc.maDanhMuc ? " bg-gray-600 text-orange-500" : " "]
                ...
                <section className="col-span-5 text-gray-400 bg-gray-900 body-font">
                    <h3 className="text-center text-white pt-2 text-7xl">Menu</h3>
                                ...
                                (item, index) => {
                                    return (
                                        <div className="p-4 lg:w-1/3" key={index}>
                                            <div className="h-full bg-gray-800 bgba-opacity-40 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                                ...
                                                <div className="text-center mt-2 leading-none flex justify-center absolute bottom-0 left-0 w-full py-4">
                                                    <span className="text-yellow-500 mr-3 inline-flex items-center leading-none text-sm px-3 py-1 border-2 border-gray-700 border-opacity-50">
                                                        <svg
